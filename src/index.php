...
use controller\GetCategorieController;
use controller\GetDepartementController;
use controller\IndexController;
use controller\KeyGeneratorController;
use controller\ViewAnnonceurController;
...
$cat = new GetCategorieController();
$dpt = new GetDepartementController();
...
$app->get('/annonceur/{n}', function ($request, $response, $arg) use ($twig, $menu, $chemin, $cat) {
    $n         = $arg['n'];
    $annonceur = new ViewAnnonceurController();
...
$app->get('/cat/{n}', function ($request, $response, $arg) use ($twig, $menu, $chemin, $cat) {
    $n = $arg['n'];
    $categorie = new GetCategorieController();
